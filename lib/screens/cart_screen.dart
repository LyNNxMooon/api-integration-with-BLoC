          ...
          itemBuilder: (context, index) => GestureDetector(
                onTap: () {
                  ...
                  productDetailBloc.add(
                      FetchProductDetail(productID: cart[index].product.id));
                  productImagesBloc.add(
                      FetchProductImages(productID: cart[index].product.id));
                  context.navigateToNext(ProductDetailScreen(
                    productID: cart[index].product.id,
                  ));
                },
                child: Container(
